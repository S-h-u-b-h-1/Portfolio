...
export const profile = {
  ...
  location: "India",
  photo: {
    src: "https://drive.google.com/file/d/1JTuk7equ_IMe4V5EORM3HP5bihgfSm4s/view?usp=sharing",
  ...
  stats: [
    ...
    },
    {
      label: "Internships",
      value: "2",
      description: "AI/ML and hiring research/strategy"
    },
    {
      label: "Hacktoberfest",
      value: "2x",
    ...
    },
    {
      label: "PAN IIT",
      value: "2026",
      description: "College representative in Long Beach, California"
    }
  ],
  contact: {
