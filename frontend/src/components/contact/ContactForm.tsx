  ...
  return (
    <form onSubmit={handleSubmit} className="rounded-3xl border border-black/5 bg-white/60 p-6 backdrop-blur-md dark:border-white/10 dark:bg-white/5 sm:p-8">
      <div className="grid gap-6 sm:grid-cols-2">
        <label className="block">
          ...
          <input
            ...
            maxLength={120}
            autoComplete="name"
            className="mt-2 h-12 w-full rounded-xl border border-black/5 bg-white/80 px-4 text-base text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-accent-cyan/50 focus:bg-white focus:ring-2 focus:ring-accent-cyan/20 dark:border-white/10 dark:bg-black/20 dark:text-slate-100 dark:focus:border-accent-cyan/50 dark:focus:bg-black/40"
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        ...
        <label className="block">
          <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">Purpose</span>
          <select
            value={formData.purpose}
            onChange={handleInputChange("purpose")}
            required
            className="mt-2 h-12 w-full rounded-xl border border-black/5 bg-white/80 px-4 text-base text-slate-900 outline-none transition focus:border-accent-cyan/50 focus:bg-white focus:ring-2 focus:ring-accent-cyan/20 dark:border-white/10 dark:bg-black/20 dark:text-slate-100 dark:focus:border-accent-cyan/50 dark:focus:bg-black/40"
          >
      ...
      <label className="mt-6 block">
        ...
        <textarea
          ...
          maxLength={4000}
          rows={5}
          className="mt-2 w-full resize-y rounded-xl border border-black/5 bg-white/80 px-4 py-3 text-base leading-relaxed text-slate-900 outline-none transition placeholder:text-slate-400 focus:border-accent-cyan/50 focus:bg-white focus:ring-2 focus:ring-accent-cyan/20 dark:border-white/10 dark:bg-black/20 dark:text-slate-100 dark:focus:border-accent-cyan/50 dark:focus:bg-black/40"
