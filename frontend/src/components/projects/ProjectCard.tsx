  ...
  return (
    ...
    >
      <div className="flex items-start justify-between">
        ...
        <span className="rounded-full bg-accent-cyan/10 px-3 py-1.5 text-xs font-bold uppercase tracking-wider text-accent-cyan">
      ...
      <p className="mt-3 text-base leading-relaxed text-slate-600 line-clamp-3 dark:text-slate-400">
        {project.summary}
      </p>
      ...
      <div className="mt-5 flex flex-wrap gap-2">
        {project.tags.slice(0, 4).map((tag) => (
          <span
            key={tag}
            className="rounded-full bg-slate-100 px-3 py-1.5 text-xs font-semibold text-slate-600 dark:bg-white/5 dark:text-slate-200"
          >
            {tag}
          </span>
        ))}
      ...
      <div className="mt-auto pt-6">
        <div className="mb-4 grid gap-3 border-t border-black/5 pt-4 dark:border-white/5">
          <div>
            ...
            <p className="mt-1 text-sm leading-relaxed text-slate-700 line-clamp-2 dark:text-slate-300">
              {project.impact[0]}
            </p>
          </div>
          <div>
        ...
        <button
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-full border border-transparent bg-slate-900 px-5 py-3.5 text-base font-bold text-white transition hover:bg-slate-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-900 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200"
        >
          View Case Study
